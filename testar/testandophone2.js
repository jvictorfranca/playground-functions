...
// let array = [5, 2, 8, 1, 5, 3, 7, 2, 8, 9, 1]
...
function checkPhone(array){
  if (array.length === 11 && maiorRepeticao(array, achaUnicos(array)) < 3 && menoresQueZero(array) === true && maioresQue10(array) === true) {
    answer = true;
...
console.log(generatePhoneNumber([8, 2, 8, 1, 5, 3, 7, 2, 8, 9, 1]))
